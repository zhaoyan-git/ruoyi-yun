<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="采集时间(默认为分钟)" prop="svalue">
        <el-input
          v-model="queryParams.svalue"
          placeholder="请输入采集时间(默认为分钟)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:strategy:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:strategy:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="strategyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="采集策略名称" align="center" prop="name" />
      <el-table-column label="设备id" align="center" prop="businessId" />
      <el-table-column label="采集时间(默认为分钟)" align="center" prop="svalue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="采集策略名称" prop="name">
        ...
        <el-form-item label="采集时间(默认为分钟)" prop="svalue">
          <el-input v-model="form.svalue" placeholder="请输入采集时间(默认为分钟)" />
        </el-form-item>
...
<script>
import { listStrategy, getStrategy, delStrategy, addStrategy, updateStrategy } from "@/api/business/strategy";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('business/strategy/export', {
        ...this.queryParams
